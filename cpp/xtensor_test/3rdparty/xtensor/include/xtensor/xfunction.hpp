...
struct xfunction_cache_impl<fixed_shape<N...>, is_shape_trivial> {
  XTENSOR_CONSTEXPR_ENHANCED_STATIC fixed_shape<N...> shape =
      fixed_shape<N...>();
...
template <std::size_t... N, class is_shape_trivial>
constexpr bool
    xfunction_cache_impl<fixed_shape<N...>, is_shape_trivial>::is_trivial;

template <std::size_t... N, class is_shape_trivial>
constexpr bool
    xfunction_cache_impl<fixed_shape<N...>, is_shape_trivial>::is_initialized;
#endif
...
template <class... CT>
using xfunction_bool_load_type_t =
...
struct xfunction_cache
    : detail::xfunction_cache_impl<typename promote::type, promote> {};
...
struct xcontainer_inner_types<xfunction<F, CT...>> {
  ...
  using value_type = typename meta_identity<decltype(std::declval<F>()(
...
class xfunction : private xconst_iterable<xfunction<F, CT...>>,
 ...
 public:
  ...
  using bool_load_type = detail::xfunction_bool_load_type_t<
      CT...>;  // xtl::promote_type_t<typename
  ...
  template <class Func, class... CTA,
            class U = std::enable_if_t<
                !std::is_base_of<std::decay_t<Func>, self_type>::value>>
 ...
 private:
  ...
  const_stepper build_stepper(Func&& f,
  ...
  tuple_type m_e;
  functor_type m_f;
  mutable xfunction_cache<
      detail::promote_index<typename std::decay_t<CT>::shape_type...>>
      m_cache;
...
class xfunction_iterator : public xtl::xrandom_access_iterator_base<
 ...
 private:
  using data_type = std::tuple<decltype(linear_begin(
      std::declval<const std::decay_t<CT>>()))...>;
...
inline auto xfunction<F, CT...>::dimension() const noexcept -> size_type {
  size_type dimension =
      m_cache.is_initialized ? m_cache.shape.size() : compute_dimension();
  return dimension;
}
...
inline void xfunction<F, CT...>::compute_cached_shape() const {
  ...
  m_cache.shape =
      uninitialized_shape<xindex_type_t<inner_shape_type>>(compute_dimension());
...
inline bool xfunction<F, CT...>::is_contiguous() const noexcept {
  return layout() != layout_type::dynamic &&
         accumulate(
             [](bool r, const auto& exp) { return r && exp.is_contiguous(); },
             true, m_e);
}
 ...
 * greater than the number of dimensions of the function.
 */
template <class F, class... CT>
template <class... Args>
inline auto xfunction<F, CT...>::operator()(Args... args) const
    -> const_reference {
 ...
 */
/**
 * Returns a constant reference to the element at the specified position of the
 * underlying contiguous storage of the function.
 * @param index index to underlying flat storage.
 */
template <class F, class... CT>
inline auto xfunction<F, CT...>::flat(size_type index) const
    -> const_reference {
...
template <class F, class... CT>
template <class... Args>
inline auto xfunction<F, CT...>::unchecked(Args... args) const
    -> const_reference {
  // The static cast prevents the compiler from instantiating the template
  // methods with signed integers, leading to warning about signed/unsigned
  // conversions in the deeper layers of the access methods
...
template <class F, class... CT>
template <class It>
inline auto xfunction<F, CT...>::element(It first, It last) const
    -> const_reference {
...
template <class F, class... CT>
template <class S>
inline bool xfunction<F, CT...>::broadcast_shape(S& shape,
...
template <class F, class... CT>
template <class S>
inline bool xfunction<F, CT...>::has_linear_assign(
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::storage_begin() const noexcept
    -> const_storage_iterator {
  return storage_cbegin();
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::storage_end() const noexcept
    -> const_storage_iterator {
  return storage_cend();
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::storage_cbegin() const noexcept
    -> const_storage_iterator {
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::storage_cend() const noexcept
    -> const_storage_iterator {
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::storage_rend() const noexcept
    -> const_reverse_storage_iterator {
...
template <class F, class... CT>
template <class S>
inline auto xfunction<F, CT...>::stepper_begin(const S& shape) const noexcept
    -> const_stepper {
...
template <class F, class... CT>
template <class S>
inline auto xfunction<F, CT...>::stepper_end(const S& shape,
...
template <class F, class... CT>
inline auto xfunction<F, CT...>::data_element(size_type i) const
    -> const_reference {
...
inline auto xfunction<F, CT...>::load_simd(size_type i) const
  ...
  return load_simd_impl<align, requested_type, N>(
      std::make_index_sequence<sizeof...(CT)>(), i);
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::arguments() const noexcept
    -> const tuple_type& {
  return m_e;
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::functor() const noexcept
    -> const functor_type& {
  return m_f;
}
...
template <class F, class... CT>
template <std::size_t... I>
inline layout_type xfunction<F, CT...>::layout_impl(
    std::index_sequence<I...>) const noexcept {
...
template <class F, class... CT>
template <std::size_t... I, class... Args>
inline auto xfunction<F, CT...>::access_impl(std::index_sequence<I...>,
                                             Args... args) const
    -> const_reference {
...
template <class F, class... CT>
template <std::size_t... I, class... Args>
inline auto xfunction<F, CT...>::unchecked_impl(std::index_sequence<I...>,
                                                Args... args) const
    -> const_reference {
...
template <class F, class... CT>
template <std::size_t... I>
inline auto xfunction<F, CT...>::data_element_impl(std::index_sequence<I...>,
                                                   size_type i) const
    -> const_reference {
...
template <class F, class... CT>
template <class align, class requested_type, std::size_t N, std::size_t... I>
inline auto xfunction<F, CT...>::load_simd_impl(std::index_sequence<I...>,
                                                size_type i) const {
  return m_f.simd_apply(
      (std::get<I>(m_e).template load_simd<align, requested_type>(i))...);
}

template <class F, class... CT>
template <class Func, std::size_t... I>
inline auto xfunction<F, CT...>::build_stepper(
...
template <class F, class... CT>
template <class Func, std::size_t... I>
inline auto xfunction<F, CT...>::build_iterator(
    Func&& f, std::index_sequence<I...>) const noexcept {
  return const_storage_iterator(this, f(std::get<I>(m_e))...);
}

template <class F, class... CT>
inline auto xfunction<F, CT...>::compute_dimension() const noexcept
    -> size_type {
...
template <class F, class... CT>
template <class... It>
inline xfunction_iterator<F, CT...>::xfunction_iterator(
...
template <class F, class... CT>
inline auto xfunction_iterator<F, CT...>::operator+=(difference_type n)
    -> self_type& {
...
inline auto xfunction_iterator<F, CT...>::operator-(const self_type& rhs) const
    -> difference_type {
  return tuple_max_diff(std::make_index_sequence<sizeof...(CT)>(), m_it,
                        rhs.m_it);
}
...
inline bool xfunction_iterator<F, CT...>::equal(const self_type& rhs) const {
  ...
  constexpr std::size_t temp =
      xtl::mpl::find_if<is_not_xdummy_iterator, data_type>::value;
  constexpr std::size_t index =
      (temp == std::tuple_size<data_type>::value) ? 0 : temp;
  return std::get<index>(m_it) == std::get<index>(rhs.m_it);
}

template <class F, class... CT>
inline bool xfunction_iterator<F, CT...>::less_than(
...
template <class F, class... CT>
template <std::size_t... I>
inline auto xfunction_iterator<F, CT...>::deref_impl(
...
inline auto xfunction_iterator<F, CT...>::tuple_max_diff(
    std::index_sequence<I...>, const data_type& lhs, const data_type& rhs) const
    -> difference_type {
...
template <class F, class... CT>
template <class... St>
inline xfunction_stepper<F, CT...>::xfunction_stepper(
...
template <class F, class... CT>
template <std::size_t... I>
inline auto xfunction_stepper<F, CT...>::deref_impl(
    std::index_sequence<I...>) const -> reference {
...
template <class F, class... CT>
template <class T, std::size_t... I>
inline auto xfunction_stepper<F, CT...>::step_simd_impl(
    std::index_sequence<I...>) -> simd_return_type<T> {
