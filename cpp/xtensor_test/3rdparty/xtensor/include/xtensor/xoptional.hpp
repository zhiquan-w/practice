...
struct split_optional_expression_impl_base {
  ...
  using value_expression =
      std::conditional_t<is_const, typename decay_type::const_value_expression,
                         typename decay_type::value_expression>;
  using flag_expression =
      std::conditional_t<is_const, typename decay_type::const_flag_expression,
...
class optional_bitwise {
 ...
 private:
  constexpr result_type apply_impl() const { return true; }
  ...
  constexpr B1 simd_apply_impl(const B1& b1, const B2& b2,
...
struct xscalar_optional_traits {
  ...
  using value_closure =
      std::conditional_t<is_ref, std::add_lvalue_reference_t<raw_value_closure>,
                         raw_value_closure>;
  using flag_closure =
      std::conditional_t<is_ref, std::add_lvalue_reference_t<raw_flag_closure>,
                         raw_flag_closure>;
...
class xcontainer_optional_base
    : public xoptional_empty_base<typename T::derived_type> {
 public:
  using traits = T;
  using value_expression = typename traits::value_expression;
  using flag_expression = typename traits::flag_expression;
...
class xfunction_optional_base
    : public xoptional_empty_base<xfunction<F, CT...>> {
 public:
  using expression_tag = xoptional_expression_tag;
  ...
  using flag_expression =
      xfunction<flag_functor, xt::detail::flag_expression_t<CT>...>;
...
class xdynamic_view_optional
    : public xoptional_empty_base<xdynamic_view<CT, S, L, FST>> {
 public:
  using expression_tag = xoptional_expression_tag;
  ...
  using value_expression =
      xdynamic_view<uvt, S, L, typename FST::template rebind_t<uvt>>;
  using flag_expression =
      xdynamic_view<uft, S, L, typename FST::template rebind_t<uft>>;
...
class xfunctor_view_optional
    : public xoptional_empty_base<xfunctor_view<F, CT>> {
 public:
  using expression_tag = xoptional_expression_tag;
  using uvt = typename std::decay_t<CT>::value_expression;
  using uft = typename std::decay_t<CT>::flag_expression;
...
class xreducer_optional : public xoptional_empty_base<xreducer<F, CT, X, O>> {
 public:
  ...
  using rebound_functors_type =
      typename F::template rebind_t<rebound_result_type>;
  using rebound_reduce_options_values =
  ...
  using flag_reducer = xreducer_functors<xt::detail::optional_bitwise<bool>,
                                         xt::const_value<bool>>;
  using flag_expression =
      xreducer<flag_reducer, xt::detail::flag_expression_t<CT>, X,
               rebound_reduce_options_flag>;
  using value_expression =
      xreducer<rebound_functors_type, xt::detail::value_expression_t<CT>, X,
...
namespace extension {
template <class CT, class S, layout_type L, class FST>
class xstrided_view_optional
    : public xoptional_empty_base<xstrided_view<CT, S, L, FST>> {
 public:
  using expression_tag = xoptional_expression_tag;
  using uvt = typename std::decay_t<CT>::value_expression;
  using uft = typename std::decay_t<CT>::flag_expression;
  ...
  using ucft = typename std::decay_t<CT>::const_flag_expression;
  using value_expression =
      xstrided_view<uvt, S, L, typename FST::template rebind_t<uvt>>;
  using flag_expression =
      xstrided_view<uft, S, L, typename FST::template rebind_t<uft>>;
  using const_value_expression =
...
struct value_functor {
  ...
  static type get(const F& f) { return f; }
};
...
struct value_functor<F, void_t<typename F::value_functor_type>> {
  ...
  static type get(const F& f) { return f.value_functor(); }
};
...
struct flag_functor {
  ...
  static type get(const F&) { return type(); }
};
...
struct flag_functor<F, void_t<typename F::flag_functor_type>> {
  ...
  static type get(const F& f) { return f.flag_functor(); }
};
...
template <class CT>
inline auto xscalar_optional_base<CT>::has_value() const
...
template <class T>
inline auto xcontainer_optional_base<T>::value() const
...
template <class T>
inline auto xcontainer_optional_base<T>::has_value() const
    -> const_flag_expression {
...
namespace extension {
template <class F, class... CT>
inline auto xfunction_optional_base<F, CT...>::value() const
    -> const_value_expression {
  return value_impl(std::make_index_sequence<sizeof...(CT)>());
}

template <class F, class... CT>
inline auto xfunction_optional_base<F, CT...>::has_value() const
    -> const_flag_expression {
...
template <class F, class... CT>
template <std::size_t... I>
inline auto xfunction_optional_base<F, CT...>::value_impl(
    std::index_sequence<I...>) const -> const_value_expression {
  return value_expression(
      value_functor(), xt::detail::split_optional_expression<CT>::value(
...
inline auto xdynamic_view_optional<CT, S, L, FST>::value() -> value_expression {
  return this->derived_cast().build_view(
      this->derived_cast().expression().value());
}

template <class CT, class S, layout_type L, class FST>
inline auto xdynamic_view_optional<CT, S, L, FST>::value() const
    -> const_value_expression {
  return this->derived_cast().build_view(
      this->derived_cast().expression().value());
}
...
template <class CT, class S, layout_type L, class FST>
inline auto xdynamic_view_optional<CT, S, L, FST>::has_value()
    -> flag_expression {
  return this->derived_cast().build_view(
...
namespace extension {
template <class CT, class X>
inline auto xbroadcast_optional<CT, X>::value() const
    -> const_value_expression {
...
template <class CT, class X>
inline auto xbroadcast_optional<CT, X>::has_value() const
    -> const_flag_expression {
  return this->derived_cast().build_broadcast(
      this->derived_cast().expression().has_value());
}
...
template <class F, class CT>
inline auto xfunctor_view_optional<F, CT>::value() const
    -> const_value_expression {
  return this->derived_cast().build_functor_view(
      this->derived_cast().expression().value());
}
...
template <class F, class CT>
inline auto xfunctor_view_optional<F, CT>::has_value() const
    -> const_flag_expression {
  return this->derived_cast().expression().has_value();
}
}  // namespace extension
...
template <class CT, class I>
inline auto xindex_view_optional<CT, I>::value() const
    -> const_value_expression {
  return this->derived_cast().build_index_view(
      this->derived_cast().expression().value());
};
...
template <class CT, class I>
inline auto xindex_view_optional<CT, I>::has_value() const
    -> const_flag_expression {
  return this->derived_cast().build_index_view(
      this->derived_cast().expression().has_value());
};
...
namespace extension {
template <class F, class CT, class X, class O>
inline auto xreducer_optional<F, CT, X, O>::value() const
    -> const_value_expression {
  auto func = this->derived_cast().functors();
  auto opts =
      this->derived_cast().options().template rebind<rebound_result_type>(
          this->derived_cast().options().initial_value.value(),
          this->derived_cast().options());

  return this->derived_cast().build_reducer(
      this->derived_cast().expression().value(),
      func.template rebind<rebound_result_type>(), std::move(opts));
}

template <class F, class CT, class X, class O>
inline auto xreducer_optional<F, CT, X, O>::has_value() const
    -> const_flag_expression {
...
template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view_optional<CT, S, L, FST>::value() const
    -> const_value_expression {
  return this->derived_cast().build_view(
      this->derived_cast().expression().value());
}
...
template <class CT, class S, layout_type L, class FST>
inline auto xstrided_view_optional<CT, S, L, FST>::has_value()
    -> flag_expression {
  return this->derived_cast().build_view(
      this->derived_cast().expression().has_value());
}
...
template <class CT, class... S>
inline auto xview_optional<CT, S...>::has_value() const
    -> const_flag_expression {
  return this->derived_cast().build_view(
      this->derived_cast().expression().has_value());
}
...
namespace extension {
template <class F, class R, class S>
inline auto xgenerator_optional<F, R, S>::value() const
    -> const_value_expression {
...
template <class F, class R, class S>
inline auto xgenerator_optional<F, R, S>::has_value() const
    -> const_flag_expression {
...
struct assign_data_impl {
  template <class E1, class E2>
  static void run(xexpression<E1>& e1, const xexpression<E2>& e2,
                  bool trivial) {
...
struct xarray_assigner {
  template <class E1, class E2>
  static void assign(xexpression<E1>& e1, const xexpression<E2>& e2,
                     bool trivial) {
    E1& de1 = e1.derived_cast();
    const E2& de2 = e2.derived_cast();
    ...
    decltype(auto) bde1 = xt::value(de1);
    decltype(auto) hde1 = xt::has_value(de1);
    xexpression_assigner_base<xtensor_expression_tag>::assign_data(bde1, e2,
                                                                   trivial);
    xexpression_assigner_base<xtensor_expression_tag>::assign_data(hde1, mask,
                                                                   trivial);
  }
};
...
struct xarray_assigner<xtl::xoptional<T>> {
  ...
  static void assign(xexpression<E1>& e1, const xexpression<E2>& e2,
                     bool trivial) {
    xexpression_assigner_base<xtensor_expression_tag>::assign_data(e1, e2,
                                                                   trivial);
  }
};
...
inline void xexpression_assigner_base<xoptional_expression_tag>::assign_data(
  ...
  detail::assign_data_impl<typename E1::expression_tag,
                           typename E2::expression_tag>::run(e1, e2, trivial);
}
}  // namespace xt
