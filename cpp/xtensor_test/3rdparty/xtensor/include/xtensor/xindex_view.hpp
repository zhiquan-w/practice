 ...
 * xindex_view is not meant to be used directly, but only with the \ref
 * index_view and \ref filter helper functions.
 *
...
class xindex_view : public xview_semantic<xindex_view<CT, I>>,
 ...
 public:
  ...
  template <class... Args>
  const_reference operator()(size_type idx0, size_type idx1,
                             Args... args) const;
...
template <class CT, class I>
template <class E>
inline auto xindex_view<CT, I>::operator=(const xexpression<E>& e)
    -> self_type& {
...
template <class CT, class I>
template <class E>
inline auto xindex_view<CT, I>::operator=(const E& e)
 ...
 */
template <class CT, class I>
inline auto xindex_view<CT, I>::shape() const noexcept
 ...
 * xindex_view.
 * @param idx index specifying the position in the index_view. More indices may
 * be provided, only the last one will be used.
 */
template <class CT, class I>
...
template <class CT, class I>
template <class... Args>
inline auto xindex_view<CT, I>::operator()(size_type, size_type idx1,
                                           Args... args) -> reference {
 ...
 */
template <class CT, class I>
inline auto xindex_view<CT, I>::operator()(size_type idx) const
    -> const_reference {
  return m_e[m_indices[idx]];
}
 ...
 */
template <class CT, class I>
inline auto xindex_view<CT, I>::unchecked(size_type idx) const
    -> const_reference {
  return this->operator()(idx);
}
 ...
 * Indices must be unsigned integers, the number of indices in the list should
 * be equal or greater than the number of dimensions of the container.
 */
template <class CT, class I>
template <class S>
...
template <class CT, class I>
template <class OI>
inline auto xindex_view<CT, I>::operator[](
    std::initializer_list<OI> index) const -> const_reference {
  return m_e[m_indices[*(index.begin())]];
}

template <class CT, class I>
inline auto xindex_view<CT, I>::operator[](size_type i) const
    -> const_reference {
  return operator()(i);
}
...
template <class CT, class I>
template <class It>
inline auto xindex_view<CT, I>::element(It first, It /*last*/) const
    -> const_reference {
  return m_e[m_indices[(*first)]];
}
 ...
 */
template <class CT, class I>
inline auto xindex_view<CT, I>::expression() const noexcept
...
template <class CT, class I>
template <class O>
inline bool xindex_view<CT, I>::has_linear_assign(
...
template <class CT, class I>
template <class ST>
inline auto xindex_view<CT, I>::stepper_end(const ST& shape, layout_type)
    -> stepper {
  size_type offset = shape.size() - dimension();
...
template <class CT, class I>
template <class ST>
inline auto xindex_view<CT, I>::stepper_begin(const ST& shape) const
    -> const_stepper {
  size_type offset = shape.size() - dimension();
...
template <class CT, class I>
template <class ST>
inline auto xindex_view<CT, I>::stepper_end(const ST& shape, layout_type) const
    -> const_stepper {
  size_type offset = shape.size() - dimension();
 ...
 * \em true. This is equivalent to \verbatim{index_view(e,
 * argwhere(condition));}\endverbatim The returned view is not optimal if you
 * just want to assign a scalar to the filtered elements. In that case, you
 * should consider using the \ref filtration function instead.
 *
