...
using select_expression_base_t =
    std::conditional_t<detail::is_sharable<D>::value, xsharable_expression<D>,
                       xexpression<D>>;
 ...
 * xsemantic_base provides the interface.
 */
template <class D>
...
template <class E, class R = void>
using enable_xview_semantics =
    typename std::enable_if<has_view_semantics<E>::value, R>::type;

template <class E, class R = void>
using disable_xview_semantics =
    typename std::enable_if<!has_view_semantics<E>::value, R>::type;
...
/**
 * Computes the bitwise and of \c *this and the scalar \c e and assigns it to \c
 * *this.
 * @param e the scalar involved in the operation.
 * @return a reference to \c *this.
 */
...
/**
 * Computes the bitwise or of \c *this and the scalar \c e and assigns it to \c
 * *this.
 * @param e the scalar involved in the operation.
 * @return a reference to \c *this.
 */
...
/**
 * Computes the bitwise xor of \c *this and the scalar \c e and assigns it to \c
 * *this.
 * @param e the scalar involved in the operation.
 * @return a reference to \c *this.
 */
...
/**
 * Computes the bitwise and of \c *this and the xexpression \c e and assigns it
 * to \c *this.
 * @param e the xexpression involved in the operation.
 * @return a reference to \c *this.
 */
...
/**
 * Computes the bitwise or of \c *this and the xexpression \c e and assigns it
 * to \c *this.
 * @param e the xexpression involved in the operation.
 * @return a reference to \c *this.
 */
...
/**
 * Computes the bitwise xor of \c *this and the xexpression \c e and assigns it
 * to \c *this.
 * @param e the xexpression involved in the operation.
 * @return a reference to \c *this.
 */
...
template <class D>
template <class E>
inline auto xsemantic_base<D>::modulus_assign(const xexpression<E>& e)
    -> derived_type& {
  return this->derived_cast().computed_assign(this->derived_cast() %
                                              e.derived_cast());
}
...
template <class D>
template <class E>
inline auto xsemantic_base<D>::bit_and_assign(const xexpression<E>& e)
    -> derived_type& {
  return this->derived_cast().computed_assign(this->derived_cast() &
                                              e.derived_cast());
}
...
template <class D>
template <class E>
inline auto xsemantic_base<D>::bit_or_assign(const xexpression<E>& e)
    -> derived_type& {
  return this->derived_cast().computed_assign(this->derived_cast() |
                                              e.derived_cast());
}
...
template <class D>
template <class E>
inline auto xsemantic_base<D>::bit_xor_assign(const xexpression<E>& e)
    -> derived_type& {
  return this->derived_cast().computed_assign(this->derived_cast() ^
                                              e.derived_cast());
}
...
template <class D>
template <class E>
inline auto xview_semantic<D>::operator=(const xexpression<E>& rhs)
    -> derived_type& {
  bool cond =
      (rhs.derived_cast().shape().size() == this->derived_cast().dimension()) &&
