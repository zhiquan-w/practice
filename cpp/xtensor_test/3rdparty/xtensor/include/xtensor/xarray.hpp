...
template <class EC, layout_type L, class SC, class Tag>
using xarray_container_base_t =
    typename xarray_container_base<EC, L, SC, Tag>::type;
}  // namespace extension
...
class xarray_container
 ...
 public:
  ...
  explicit xarray_container(const shape_type& shape,
                            const strides_type& strides, const_reference value);
  explicit xarray_container(storage_type&& storage, inner_shape_type&& shape,
...
template <class EC, layout_type L, class SC, class Tag>
using xarray_adaptor_base_t =
    typename xarray_adaptor_base<EC, L, SC, Tag>::type;
}  // namespace extension
...
struct xcontainer_inner_types<xarray_adaptor<EC, L, SC, Tag>> {
  ...
  using temporary_type =
      xarray_container<temporary_container_t<storage_type>, L, SC, Tag>;
  static constexpr layout_type layout = L;
};
...
class xarray_adaptor
 ...
 public:
  ...
  template <class D>
  xarray_adaptor(D&& storage, const shape_type& shape,
                 const strides_type& strides);
...
inline xarray_container<EC, L, SC, Tag>::xarray_container(
    ...
    : base_type(
          ...
          inner_backstrides_type(rhs.backstrides().cbegin(),
                                 rhs.backstrides().cend()),
          std::move(rhs.layout())),
...
template <class EC, layout_type L, class SC, class Tag>
template <class E>
inline auto xarray_container<EC, L, SC, Tag>::operator=(const xexpression<E>& e)
    -> self_type& {
...
template <class EC, layout_type L, class SC, class Tag>
inline auto xarray_container<EC, L, SC, Tag>::storage_impl() noexcept
    -> storage_type& {
  return m_storage;
}
...
template <class EC, layout_type L, class SC, class Tag>
inline auto xarray_adaptor<EC, L, SC, Tag>::operator=(const xarray_adaptor& rhs)
    -> self_type& {
...
template <class EC, layout_type L, class SC, class Tag>
inline auto xarray_adaptor<EC, L, SC, Tag>::operator=(xarray_adaptor&& rhs)
    -> self_type& {
...
template <class EC, layout_type L, class SC, class Tag>
inline auto xarray_adaptor<EC, L, SC, Tag>::operator=(temporary_type&& rhs)
    -> self_type& {
...
template <class EC, layout_type L, class SC, class Tag>
template <class E>
inline auto xarray_adaptor<EC, L, SC, Tag>::operator=(const xexpression<E>& e)
    -> self_type& {
  return semantic_base::operator=(e);
}
//@}
...
template <class EC, layout_type L, class SC, class Tag>
inline auto xarray_adaptor<EC, L, SC, Tag>::storage_impl() noexcept
    -> storage_type& {
  return m_storage;
}

template <class EC, layout_type L, class SC, class Tag>
inline auto xarray_adaptor<EC, L, SC, Tag>::storage_impl() const noexcept
    -> const storage_type& {
  return m_storage;
}
}  // namespace xt
