...
struct xcontainer_inner_types<xoptional_assembly<VE, FE>> {
  ...
  using storage_type =
      xoptional_assembly_storage<value_storage_type, flag_storage_type>;
 ...
 * contrary to xarray_optional, xoptional_assembly holds two separated
 * expressions, one for the values, the other for the missing mask.
 *
...
class xoptional_assembly
 ...
 public:
  ...
  explicit xoptional_assembly(const shape_type& shape, const value_type& value,
                              layout_type l = base_type::static_layout);
  explicit xoptional_assembly(const shape_type& shape,
  ...
  template <class OVE, class OFE,
            typename = std::enable_if_t<is_xexpression<OVE>::value &&
                                        is_xexpression<OFE>::value>>
...
struct xcontainer_inner_types<xoptional_assembly_adaptor<VEC, FEC>> {
  ...
  using temporary_type =
      xoptional_assembly<raw_value_expression, raw_flag_expression>;
};
 ...
 * optimized for tensor operations.
 *
 * The xoptional_assembly_adaptor class implements a dense multidimensional
 * adaptor hoding optional values. It is used to provide an optional expression
 * semantic to two tensor expressions, one holding the value, the hother holding
 * the missing mask.
 *
...
/**
 * Allocates an xoptional_assembly that holds a single element initialized to
 * the specified value.
...
/**
 * Allocates an xoptional_assembly from the specified value expression and
 * missing mask expression.
...
template <class VE, class FE>
template <class S>
inline xoptional_assembly<VE, FE> xoptional_assembly<VE, FE>::from_shape(
    S&& s) {
...
template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::operator=(const self_type& rhs)
    -> self_type& {
...
template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::operator=(self_type&& rhs)
    -> self_type& {
  base_type::operator=(rhs);
...
template <class VE, class FE>
template <class E>
inline auto xoptional_assembly<VE, FE>::operator=(const xexpression<E>& e)
    -> self_type& {
...
template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::storage_impl() noexcept
    -> storage_type& {
  return m_storage;
}

template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::storage_impl() const noexcept
    -> const storage_type& {
  return m_storage;
}

template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::value_impl() noexcept
    -> value_expression {
  return m_value;
}

template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::value_impl() const noexcept
    -> const_value_expression {
  return m_value;
}

template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::has_value_impl() noexcept
    -> flag_expression {
  return m_has_value;
}

template <class VE, class FE>
inline auto xoptional_assembly<VE, FE>::has_value_impl() const noexcept
...
template <class VEC, class FEC>
template <class OVE, class OFE>
inline xoptional_assembly_adaptor<VEC, FEC>::xoptional_assembly_adaptor(
    OVE&& ve, OFE&& fe)
...
template <class VEC, class FEC>
inline auto xoptional_assembly_adaptor<VEC, FEC>::operator=(
...
template <class VEC, class FEC>
inline auto xoptional_assembly_adaptor<VEC, FEC>::operator=(self_type&& rhs)
    -> self_type& {
...
template <class VEC, class FEC>
inline auto xoptional_assembly_adaptor<VEC, FEC>::storage_impl() noexcept
    -> storage_type& {
  return m_storage;
}
...
template <class VEC, class FEC>
inline auto xoptional_assembly_adaptor<VEC, FEC>::value_impl() noexcept
    -> value_expression {
  return m_value;
}
...
template <class VEC, class FEC>
inline auto xoptional_assembly_adaptor<VEC, FEC>::has_value_impl() noexcept
    -> flag_expression {
  return m_has_value;
}

template <class VEC, class FEC>
inline auto xoptional_assembly_adaptor<VEC, FEC>::has_value_impl()
    const noexcept -> const_flag_expression {
  return m_has_value;
}
}  // namespace xt
