...
class xoptional_assembly_storage {
 public:
  ...
  using value_type = xtl::xoptional<typename value_storage::value_type,
                                    typename flag_storage::value_type>;
  ...
  using val_reference =
      std::conditional_t<is_val_const, typename value_storage::const_reference,
                         typename value_storage::reference>;
  using flag_reference =
      std::conditional_t<is_flag_const, typename flag_storage::const_reference,
                         typename flag_storage::reference>;
  using reference = xtl::xoptional<val_reference, flag_reference>;
  using const_reference =
      xtl::xoptional<typename value_storage::const_reference,
...
struct xoptional_assembly_storage_iterator_traits {
  ...
  using reference = std::conditional_t<
      is_const, typename xoptional_assembly_storage_type::const_reference,
      typename xoptional_assembly_storage_type::reference>;
  using difference_type =
      typename xoptional_assembly_storage_type::difference_type;
  using pointer = std::conditional_t<
      is_const, typename xoptional_assembly_storage_type::const_pointer,
...
class xoptional_assembly_storage_iterator
 ...
 public:
  ...
  xoptional_assembly_storage_iterator(value_iterator value_it,
...
template <class VE, class FE>
template <class VE1, class FE1>
inline xoptional_assembly_storage<VE, FE>::xoptional_assembly_storage(
    const VE1& value_stor, const FE1& flag_stor)
    : m_value(value_stor), m_has_value(flag_stor) {}

template <class VE, class FE>
template <class VE1, class FE1>
inline xoptional_assembly_storage<VE, FE>::xoptional_assembly_storage(
    VE1& value_stor, FE1& flag_stor)
    : m_value(value_stor), m_has_value(flag_stor) {}
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::operator=(const self_type& rhs)
    -> self_type& {
  m_value = rhs.m_value;
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::operator=(self_type&& rhs)
    -> self_type& {
  m_value = std::forward<VE>(rhs.m_value);
  m_has_value = std::forward<FE>(rhs.m_has_value);
  return *this;
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::size() const noexcept
    -> size_type {
  return value().size();
}
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::operator[](size_type i)
    -> reference {
  return reference(value()[i], has_value()[i]);
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::operator[](size_type i) const
    -> const_reference {
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::front() const
    -> const_reference {
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::back() const
    -> const_reference {
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::data() const noexcept
    -> const_pointer {
  const_pointer(front());
}
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::begin() const noexcept
    -> const_iterator {
  return cbegin();
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::end() const noexcept
    -> const_iterator {
  return cend();
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::cbegin() const noexcept
    -> const_iterator {
  return const_iterator(value().begin(), has_value().begin());
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::cend() const noexcept
    -> const_iterator {
  return const_iterator(value().end(), has_value().end());
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::rbegin() noexcept
    -> reverse_iterator {
  return reverse_iterator(end());
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::rend() noexcept
    -> reverse_iterator {
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::rend() const noexcept
    -> const_reverse_iterator {
  return crend();
}
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::crend() const noexcept
    -> const_reverse_iterator {
...
template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::value() noexcept
    -> value_storage& {
  return m_value;
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::value() const noexcept
    -> const value_storage& {
  return m_value;
}

template <class VE, class FE>
inline auto xoptional_assembly_storage<VE, FE>::has_value() noexcept
    -> flag_storage& {
  return m_has_value;
}
...
inline xoptional_assembly_storage_iterator<
...
template <class VE, class FE, bool C>
inline auto xoptional_assembly_storage_iterator<VE, FE, C>::operator*() const
    -> reference {
...
template <class VE, class FE>
inline xoptional_assembly_storage<VE, FE> optional_assembly_storage(
    const VE& value, const FE& flag) {
  return xoptional_assembly_storage<VE, FE>(value, flag);
}

template <class VE, class FE>
inline xoptional_assembly_storage<VE, FE> optional_assembly_storage(VE& value,
                                                                    FE& flag) {
  return xoptional_assembly_storage<VE, FE>(value, flag);
}
}  // namespace xt
