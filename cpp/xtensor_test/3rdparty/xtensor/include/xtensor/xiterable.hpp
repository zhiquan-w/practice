 ...
 * xconst_iterable provides the interface.
 */
template <class D>
class xconst_iterable {
 public:
  ...
  using const_storage_iterator =
      const_layout_iterator<XTENSOR_DEFAULT_TRAVERSAL>;
  using reverse_storage_iterator =
      reverse_layout_iterator<XTENSOR_DEFAULT_TRAVERSAL>;
 ...
 private:
  ...
  const_broadcast_iterator<S, L> get_cbegin(const S& shape,
                                            bool end_index) const noexcept;
  template <layout_type L, class S>
  const_broadcast_iterator<S, L> get_cend(const S& shape,
                                          bool end_index) const noexcept;
 ...
 *
 * @tparam D The derived type, i.e. the inheriting class for which
 * xcontiguous_iterable provides the interface.
 */
template <class D>
class xcontiguous_iterable : private xiterable<D> {
 public:
  ...
  using layout_iterator =
      xiterator<typename iterable_base::stepper,
                typename iterable_base::inner_shape_type*, L>;
  template <layout_type L>
  using const_layout_iterator =
  ...
  using const_reverse_storage_iterator =
      typename storage_traits::const_reverse_iterator;
  ...
  using select_reverse_iterator =
      select_iterator_impl<L, reverse_storage_iterator,
                           reverse_layout_iterator<L>>;
  template <layout_type L>
  using select_const_reverse_iterator =
      select_iterator_impl<L, const_reverse_storage_iterator,
  ...
  using const_reverse_iterator =
      select_const_reverse_iterator<XTENSOR_DEFAULT_TRAVERSAL>;
...
template <class D>
template <layout_type L, class S>
inline auto xconst_iterable<D>::get_cbegin(const S& shape,
                                           bool end_index) const noexcept
    -> const_broadcast_iterator<S, L> {
...
template <class D>
template <layout_type L, class S>
inline auto xconst_iterable<D>::get_cend(const S& shape,
                                         bool end_index) const noexcept
    -> const_broadcast_iterator<S, L> {
...
template <class D>
template <layout_type L>
inline auto xiterable<D>::get_begin(bool end_index) noexcept
    -> layout_iterator<L> {
  return layout_iterator<L>(get_stepper_begin(this->get_shape()),
                            &(this->get_shape()), end_index);
}

template <class D>
template <layout_type L>
inline auto xiterable<D>::get_end(bool end_index) noexcept
    -> layout_iterator<L> {
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::begin() const noexcept
    -> select_const_iterator<L> {
  return this->template cbegin<L>();
}
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::end() const noexcept
    -> select_const_iterator<L> {
  return this->template cend<L>();
}
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::cbegin() const noexcept
    -> select_const_iterator<L> {
  return xtl::mpl::static_if<L == static_layout>(
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::cend() const noexcept
    -> select_const_iterator<L> {
  return xtl::mpl::static_if<L == static_layout>(
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::rbegin() noexcept
    -> select_reverse_iterator<L> {
  return xtl::mpl::static_if<L == static_layout>(
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::rend() noexcept
    -> select_reverse_iterator<L> {
  return xtl::mpl::static_if<L == static_layout>(
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::rbegin() const noexcept
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::rend() const noexcept
    -> select_const_reverse_iterator<L> {
  return this->template crend<L>();
}
...
template <class D>
template <layout_type L>
inline auto xcontiguous_iterable<D>::crend() const noexcept
    -> select_const_reverse_iterator<L> {
  return xtl::mpl::static_if<L == static_layout>(
...
template <class D>
template <layout_type L, class S>
inline auto xcontiguous_iterable<D>::begin(const S& shape) noexcept
    -> broadcast_iterator<S, L> {
...
template <class D>
template <layout_type L, class S>
inline auto xcontiguous_iterable<D>::end(const S& shape) noexcept
    -> broadcast_iterator<S, L> {
...
template <class D>
inline auto xcontiguous_iterable<D>::derived_cast() const
    -> const derived_type& {
  return *static_cast<const derived_type*>(this);
}
