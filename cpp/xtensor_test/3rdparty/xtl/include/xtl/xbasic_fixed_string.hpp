...
template <class CT, std::size_t N = 55, int ST = buffer | store_size,
          template <std::size_t> class EP = string_policy::silent_error,
          class TR = std::char_traits<CT>>
class xbasic_fixed_string;

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
std::basic_ostream<CT, TR>& operator<<(
    std::basic_ostream<CT, TR>& os,
    const xbasic_fixed_string<CT, N, ST, EP, TR>& str);

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
std::basic_istream<CT, TR>& operator>>(
    std::basic_istream<CT, TR>& is,
    xbasic_fixed_string<CT, N, ST, EP, TR>& str);

template <class CT>
using xbasic_string_view =
    xbasic_fixed_string<const CT, 0, pointer | store_size | is_const>;
...
struct fixed_small_string_storage_impl<T[N]> {
  ...
  fixed_small_string_storage_impl() { set_size(0); }

  fixed_small_string_storage_impl(T ptr[N], std::size_t size) : m_buffer(ptr) {
    m_buffer[N - 1] = N - size;
  }
  ...
  void set_size(std::size_t sz) {
    ...
    // Don't use std::make_unsinged_t here, this should remain C++11 compatible
    using unsigned_type = typename std::make_unsigned<T>::type;
    reinterpret_cast<unsigned_type*>(m_buffer)[N - 1] =
        static_cast<unsigned_type>(N - sz);
    m_buffer[sz] = '\0';
  }
  ...
  void adjust_size(std::ptrdiff_t val) {
    ...
    set_size(
        static_cast<std::size_t>(static_cast<std::ptrdiff_t>(size()) + val));
  }
...
struct fixed_string_external_storage_impl {
  ...
  void set_size(std::size_t sz) { m_buffer[sz] = '\0'; }

  void adjust_size(std::ptrdiff_t val) { m_buffer[size() + val] = '\0'; }

  std::size_t size() const { return std::strlen(m_buffer); }
...
struct select_storage<buffer | store_size> {
  template <class T, std::size_t N>
  using type = typename select_fixed_storage < T[N + 1],
        N<(1u << (8 * sizeof(T)))>::type;
};
...
class xbasic_fixed_string {
 public:
  ...
  using storage_type =
      typename detail::select_storage<ST>::template type<CT, N>;
  ...
  explicit xbasic_fixed_string(const self_type& other, size_type pos,
                               size_type count = npos);
  explicit xbasic_fixed_string(const string_type& other);
  explicit xbasic_fixed_string(const string_type& other, size_type pos,
                               size_type count = npos);
  ...
  self_type& assign(const self_type& other, size_type pos,
                    size_type count = npos);
  ...
  self_type& assign(const string_type& other, size_type pos,
                    size_type count = npos);
  ...
  self_type& insert(size_type index, const self_type& str, size_type index_str,
                    size_type count = npos);
  ...
  self_type& append(const self_type& str, size_type pos,
                    size_type count = npos);
  self_type& append(const string_type& str);
  self_type& append(const string_type& str, size_type pos,
                    size_type count = npos);
  ...
  self_type& replace(const_iterator first, const_iterator last,
                     const self_type& str);
  ...
  self_type& replace(const_iterator first, const_iterator last,
                     const_pointer cstr);
  self_type& replace(size_type pos, size_type count, size_type count2,
                     value_type ch);
  self_type& replace(const_iterator first, const_iterator last,
                     size_type count2, value_type ch);
  self_type& replace(const_iterator first, const_iterator last,
                     initializer_type ilist);
  template <class InputIt>
  self_type& replace(const_iterator first, const_iterator last, InputIt first2,
                     InputIt last2);
  ...
  size_type find_first_of(const self_type& str,
                          size_type pos = 0) const noexcept;
  size_type find_first_of(const string_type& str,
                          size_type pos = 0) const noexcept;
  ...
  size_type find_first_not_of(const self_type& str,
                              size_type pos = 0) const noexcept;
  size_type find_first_not_of(const string_type& str,
                              size_type pos = 0) const noexcept;
  ...
  size_type find_last_of(const self_type& str,
                         size_type pos = 0) const noexcept;
  size_type find_last_of(const string_type& str,
                         size_type pos = 0) const noexcept;
  ...
  size_type find_last_not_of(const self_type& str,
                             size_type pos = npos) const noexcept;
  size_type find_last_not_of(const string_type& str,
                             size_type pos = npos) const noexcept;
 ...
 private:
  int compare_impl(const_pointer s1, size_type count1, const_pointer s2,
  ...
  void check_index_strict(size_type pos, size_type size,
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
const typename xbasic_fixed_string<CT, N, ST, EP, TR>::size_type
    xbasic_fixed_string<CT, N, ST, EP, TR>::npos =
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
xbasic_fixed_string<CT, N, ST, EP, TR> operator+(
    const xbasic_fixed_string<CT, N, ST, EP, TR>& lhs,
    const xbasic_fixed_string<CT, N, ST, EP, TR>& rhs);

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
xbasic_fixed_string<CT, N, ST, EP, TR> operator+(
    const xbasic_fixed_string<CT, N, ST, EP, TR>& lhs, const CT* rhs);

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
xbasic_fixed_string<CT, N, ST, EP, TR> operator+(
    const xbasic_fixed_string<CT, N, ST, EP, TR>& lhs, CT rhs);

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
xbasic_fixed_string<CT, N, ST, EP, TR> operator+(
    const CT* lhs, const xbasic_fixed_string<CT, N, ST, EP, TR>& rhs);

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
xbasic_fixed_string<CT, N, ST, EP, TR> operator+(
    CT lhs, const xbasic_fixed_string<CT, N, ST, EP, TR>& rhs);
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
std::basic_istream<CT, TR>& getline(
    std::basic_istream<CT, TR>& input,
    xbasic_fixed_string<CT, N, ST, EP, TR>& str);
...
struct hash<::xtl::xbasic_fixed_string<CT, N, ST, EP, TR>> {
  ...
  inline result_type operator()(const argument_type& arg) const {
    return ::xtl::hash_bytes(arg.data(), arg.size(),
...
template <std::size_t N>
struct silent_error {
  inline static std::size_t check_size(std::size_t size) { return size; }
  ...
  inline static std::size_t check_size(std::size_t size) {
    if (size > N) {
      ...
      oss << "Invalid size (" << size
          << ") for xbasic_fixed_string - maximal size: " << N;
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline xbasic_fixed_string<CT, N, ST, EP, TR>::xbasic_fixed_string(
    const self_type& other, size_type pos, size_type count)
    : m_storage() {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline xbasic_fixed_string<CT, N, ST, EP, TR>::xbasic_fixed_string(
    const string_type& other, size_type pos, size_type count)
    : m_storage() {
  assign(other, pos, count);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::operator=(const_pointer s)
    -> self_type& {
  return assign(s);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::operator=(value_type ch)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::operator=(
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(size_type count,
                                                           value_type ch)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(
    const self_type& other, size_type pos, size_type count) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(const_pointer s,
                                                           size_type count)
    -> self_type& {
  m_storage.set_size(error_policy::check_size(count));
...
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(InputIt first,
                                                           InputIt last)
    -> self_type& {
  m_storage.set_size(error_policy::check_size(
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(const self_type& rhs)
    -> self_type& {
  if (this != &rhs) {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(self_type&& rhs)
    -> self_type& {
  if (this != &rhs) {
    m_storage.set_size(rhs.size());
    traits_type::copy(data(), rhs.data(), rhs.size());
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(
    const string_type& other) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::assign(
    const string_type& other, size_type pos, size_type count) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::at(size_type pos)
    -> reference {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::at(size_type pos) const
    -> const_reference {
  check_index(pos, size(), "basic_fixed_string::at");
  return this->operator[](pos);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::operator[](size_type pos)
    -> reference {
  return data()[pos];
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::front() const
    -> const_reference {
  return this->operator[](0);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::back() const
    -> const_reference {
  return this->operator[](size() - 1);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::data() const noexcept
    -> const_pointer {
  return m_storage.buffer();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::c_str() const noexcept
    -> const_pointer {
  return m_storage.buffer();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::begin() noexcept
    -> iterator {
  return data();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::begin() const noexcept
    -> const_iterator {
  return cbegin();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::end() const noexcept
    -> const_iterator {
  return cend();
}
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::cbegin() const noexcept
    -> const_iterator {
  return data();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::cend() const noexcept
    -> const_iterator {
  return data() + size();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rbegin() noexcept
    -> reverse_iterator {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rend() noexcept
    -> reverse_iterator {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rbegin() const noexcept
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rend() const noexcept
    -> const_reverse_iterator {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::crbegin() const noexcept
    -> const_reverse_iterator {
  return const_reverse_iterator(end());
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::crend() const noexcept
    -> const_reverse_iterator {
  return const_reverse_iterator(begin());
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::size() const noexcept
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::length() const noexcept
    -> size_type {
  return m_storage.size();
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::max_size() const noexcept
    -> size_type {
  return N;
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::substr(
    size_type pos, size_type count) const -> self_type {
  return self_type(*this, pos, count);
}

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::copy(pointer dest,
                                                         size_type count,
                                                         size_type pos) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline void xbasic_fixed_string<CT, N, ST, EP, TR>::swap(
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(size_type index,
                                                    size_type count,
                                                    value_type ch)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(size_type index,
                                                           const_pointer s)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(
    size_type index, const string_type& str) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(
    size_type index, const string_type& str, size_type index_str,
    size_type count) -> self_type& {
  check_index_strict(index_str, str.size(), "xbasic_fixed_string::insert");
  return insert(index, str.c_str() + index_str,
                std::min(count, str.size() - index_str));
}

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(const_iterator pos,
                                                           value_type ch)
    -> iterator {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(
    const_iterator pos, initializer_type ilist) -> iterator {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
template <class InputIt>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::insert(const_iterator pos,
                                                    InputIt first, InputIt last)
    -> iterator {
  if (cbegin() <= pos && pos < cend()) {
    size_type index = static_cast<size_type>(pos - cbegin());
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::erase(size_type index,
                                                   size_type count)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::erase(
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::erase(const_iterator first,
                                                   const_iterator last)
    -> iterator {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::append(size_type count,
                                                           value_type ch)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::append(
    const string_type& str) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::append(
    const string_type& str, size_type pos, size_type count) -> self_type& {
  check_index_strict(pos, str.size(), "xbasic_fixed_string::append");
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::append(const_pointer s,
                                                           size_type count)
    -> self_type& {
  size_type old_size = m_storage.size();
  m_storage.set_size(error_policy::check_add(size(), count));
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
template <class InputIt>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::append(InputIt first,
                                                           InputIt last)
    -> self_type& {
  size_type count = static_cast<size_type>(std::distance(first, last));
  size_type old_size = m_storage.size();
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(
    const self_type& str) const noexcept {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(
    size_type pos1, size_type count1, const self_type& str) const {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(
    size_type pos1, size_type count1, const self_type& str, size_type pos2,
    size_type count2) const {
  check_index_strict(pos1, size(), "xbasic_fixed_string::compare");
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(
    size_type pos1, size_type count1, const string_type& str) const {
  check_index_strict(pos1, size(), "xbasic_fixed_string::compare");
  return compare_impl(data() + pos1, std::min(count1, size() - pos1),
                      str.data(), str.size());
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(
    size_type pos1, size_type count1, const string_type& str, size_type pos2,
    size_type count2) const {
  check_index_strict(pos1, size(), "xbasic_fixed_string::compare");
  check_index_strict(pos2, str.size(), "xbasic_fixed_string::compare");
  return compare_impl(data() + pos1, std::min(count1, size() - pos1),
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(size_type pos1,
                                                    size_type count1,
...
int xbasic_fixed_string<CT, N, ST, EP, TR>::compare(size_type pos1,
                                                    ...
                                                    size_type count2) const {
  check_index_strict(pos1, size(), "xbasic_fixed_string::compare");
  return compare_impl(data() + pos1, std::min(count1, size() - pos1), s,
                      count2);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    size_type pos, size_type count, const self_type& str) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    const_iterator first, const_iterator last, const self_type& str)
    -> self_type& {
...
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    size_type pos1, size_type count1, const self_type& str, size_type pos2,
    size_type count2) -> self_type& {
  check_index_strict(pos2, str.size(), "xbasic_fixed_string::replace");
  return replace(pos1, count1, str.data() + pos2,
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    size_type pos, size_type count, const string_type& str) -> self_type& {
  return replace(pos, count, str.data(), str.size());
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    const_iterator first, const_iterator last, const string_type& str)
    -> self_type& {
  return replace(first, last, str.data(), str.size());
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(size_type pos,
                                                     size_type count,
                                                     const_pointer cstr,
                                                     size_type count2)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    const_iterator first, const_iterator last, const_pointer cstr,
    size_type count2) -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(size_type pos,
                                                            size_type count,
                                                            const_pointer cstr)
    -> self_type& {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    const_iterator first, const_iterator last, size_type count2, value_type ch)
    -> self_type& {
  if (cbegin() <= first && first < last && last <= cend()) {
    size_type pos = static_cast<size_type>(first - cbegin());
    size_type count = static_cast<size_type>(last - first);
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
    const_iterator first, const_iterator last, initializer_type ilist)
    -> self_type& {
...
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::replace(
  ...
  if (cbegin() <= first && first < last && last <= cend()) {
    ...
    if (erase_count > count2) {
      ...
      std::copy_backward(cbegin() + pos + erase_count, cend(),
                         data() + new_size);
      std::copy(first2, last2, data() + pos);
      m_storage.set_size(new_size);
    } else {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find(
    const self_type& str, size_type pos) const noexcept -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find(
    const string_type& str, size_type pos) const noexcept -> size_type {
  return find(str.data(), pos, str.size());
}

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::find(const_pointer s,
                                                  size_type pos,
                                                  size_type count) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find(const_pointer s,
                                                         size_type pos) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find(value_type ch,
                                                         size_type pos) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rfind(
    const self_type& str, size_type pos) const noexcept -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::rfind(const_pointer s,
                                                   size_type pos,
                                                   size_type count) const
    -> size_type {
  if (count == 0) {
  ...
  if (count <= size()) {
    ...
    for (;; --uptr) {
      if (traits_type::eq(*uptr, *s) &&
          traits_type::compare(uptr, s, count) == 0) {
        return size_type(uptr - data());
      } else if (uptr == data()) {
        break;
      }
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rfind(const_pointer s,
                                                          size_type pos) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::rfind(value_type ch,
                                                          size_type pos) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_first_of(
    const self_type& str, size_type pos) const noexcept -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_first_of(
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_first_of(
    const_pointer s, size_type pos) const -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_first_of(
    value_type ch, size_type pos) const -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_first_not_of(
    const self_type& str, size_type pos) const noexcept -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_first_not_of(
    const_pointer s, size_type pos, size_type count) const -> size_type {
  if (pos < size()) {
    const_pointer vptr = data() + size();
    for (const_pointer uptr = data() + pos; uptr < vptr; ++uptr) {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_last_of(
    const self_type& str, size_type pos) const noexcept -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_last_of(const_pointer s,
                                                          size_type pos,
                                                          size_type count) const
    -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_last_not_of(
    const self_type& str, size_type pos) const noexcept -> size_type {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
auto xbasic_fixed_string<CT, N, ST, EP, TR>::find_last_not_of(
    const_pointer s, size_type pos, size_type count) const -> size_type {
  if (size_type(0) < size()) {
    const_pointer uptr = data() + std::min(pos, size() - 1);
    for (;; --uptr) {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
int xbasic_fixed_string<CT, N, ST, EP, TR>::compare_impl(
    const_pointer s1, size_type count1, const_pointer s2,
    size_type count2) const noexcept {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline void
xbasic_fixed_string<CT, N, ST, EP, TR>::update_null_termination() noexcept {
  data()[size()] = '\0';
}

template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
void xbasic_fixed_string<CT, N, ST, EP, TR>::check_index(
    size_type pos, size_type size, const char* what) const {
  if (pos >= size) {
#if defined(XTL_NO_EXCEPTIONS)
    std::fprintf(stderr, "%s\n", what);
    std::terminate();
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
void xbasic_fixed_string<CT, N, ST, EP, TR>::check_index_strict(
    size_type pos, size_type size, const char* what) const {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline xbasic_fixed_string<CT, N, ST, EP, TR> operator+(
    const xbasic_fixed_string<CT, N, ST, EP, TR>& lhs,
    const xbasic_fixed_string<CT, N, ST, EP, TR>& rhs) {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline bool operator==(
    const CT* lhs, const xbasic_fixed_string<CT, N, ST, EP, TR>& rhs) noexcept {
  return rhs == lhs;
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline bool operator==(
    const std::basic_string<CT, TR>& lhs,
    const xbasic_fixed_string<CT, N, ST, EP, TR>& rhs) noexcept {
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline void swap(xbasic_fixed_string<CT, N, ST, EP, TR>& lhs,
                 xbasic_fixed_string<CT, N, ST, EP, TR>& rhs) {
  lhs.swap(rhs);
}
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline std::basic_ostream<CT, TR>& operator<<(
    std::basic_ostream<CT, TR>& os,
    const xbasic_fixed_string<CT, N, ST, EP, TR>& str) {
  os << str.c_str();
  return os;
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline std::basic_istream<CT, TR>& operator>>(
    std::basic_istream<CT, TR>& is,
    xbasic_fixed_string<CT, N, ST, EP, TR>& str) {
  // Not optimal
  std::string tmp;
...
template <class CT, std::size_t N, int ST, template <std::size_t> class EP,
          class TR>
inline std::basic_istream<CT, TR>& getline(
    std::basic_istream<CT, TR>& input,
    xbasic_fixed_string<CT, N, ST, EP, TR>& str, CT delim) {
  std::string tmp;
