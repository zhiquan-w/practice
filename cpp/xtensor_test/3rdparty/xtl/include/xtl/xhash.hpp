...
std::size_t hash_bytes(const void* buffer, std::size_t length,
                       std::size_t seed);
...
std::size_t murmur_hash(const void* buffer, std::size_t length,
                        std::size_t seed) {
...
// Murmur hash is an algorithm written by Austin Appleby. See
// https://github.com/aappleby/smhasher/blob/master/src/MurmurHash2.cpp
inline uint32_t murmur2_x86_impl(const void* buffer, std::size_t length,
                                 uint32_t seed) {
...
template <>
inline std::size_t murmur_hash<4>(const void* buffer, std::size_t length,
                                  std::size_t seed) {
  return std::size_t(
      murmur2_x86_impl(buffer, length, static_cast<uint32_t>(seed)));
}
...
template <>
inline std::size_t murmur_hash<8>(const void* buffer, std::size_t length,
                                  std::size_t seed) {
...
inline uint32_t murmur2_x86(const void* buffer, std::size_t length,
                            uint32_t seed) {
  return detail::murmur2_x86_impl(buffer, length, seed);
}

inline uint64_t murmur2_x64(const void* buffer, std::size_t length,
                            uint64_t seed) {
