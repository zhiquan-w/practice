...
template <class BC, class FC>
bool operator==(const xoptional_sequence<BC, FC>& lhs,
                const xoptional_sequence<BC, FC>& rhs);
...
class xoptional_array : public xoptional_sequence<std::array<T, I>, BC> {
 public:
  ...
  using base_type =
      xoptional_sequence<base_container_type, flag_container_type>;
...
struct xoptional_iterator_traits {
  ...
  using value_type =
      xoptional<typename ITV::value_type, typename ITB::value_type>;
...
template <class ITV, class ITB>
class xoptional_iterator : public xrandom_access_iterator_base2<
                               xoptional_iterator_traits<ITV, ITB>> {
 public:
  using self_type = xoptional_iterator<ITV, ITB>;
  using base_type =
      xrandom_access_iterator_base2<xoptional_iterator_traits<ITV, ITB>>;
...
template <class BC, class FC>
inline xoptional_sequence<BC, FC>::xoptional_sequence(size_type s,
...
template <class BC, class FC>
template <class CTO, class CBO>
inline xoptional_sequence<BC, FC>::xoptional_sequence(
    size_type s, const xoptional<CTO, CBO>& v)
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::at(size_type i) const
    -> const_reference {
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::operator[](size_type i) const
    -> const_reference {
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::begin() const noexcept
    -> const_iterator {
  return cbegin();
}
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::cbegin() const noexcept
    -> const_iterator {
  return const_iterator(m_values.cbegin(), m_flags.cbegin());
}

template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::cend() const noexcept
    -> const_iterator {
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::rbegin() const noexcept
    -> const_reverse_iterator {
  return crbegin();
}

template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::rend() const noexcept
    -> const_reverse_iterator {
  return crend();
}

template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::crbegin() const noexcept
    -> const_reverse_iterator {
  return const_reverse_iterator(m_values.crbegin(), m_flags.crbegin());
}

template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::crend() const noexcept
    -> const_reverse_iterator {
  return const_reverse_iterator(m_values.crend(), m_flags.crend());
}

template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::value() && noexcept
    -> base_container_type {
  return m_values;
}
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::value() const& noexcept
    -> const base_container_type& {
  return m_values;
}

template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::has_value() && noexcept
    -> flag_container_type {
  return m_flags;
}
...
template <class BC, class FC>
inline auto xoptional_sequence<BC, FC>::has_value() const& noexcept
    -> const flag_container_type& {
  return m_flags;
}

template <class BC, class FC>
inline bool operator==(const xoptional_sequence<BC, FC>& lhs,
                       const xoptional_sequence<BC, FC>& rhs) {
...
xoptional_array<T, I, BC>::xoptional_array(size_type s,
                                           const base_value_type& v)
    : base_type(s, v) {}
...
xoptional_vector<T, A, BC>::xoptional_vector(size_type s,
                                             const base_value_type& v)
    : base_type(s, v) {}
