...
class xscatter_hierarchy_generator<mpl::vector<T, Args...>, U>
    : public U<T>,
      public xscatter_hierarchy_generator<mpl::vector<Args...>, U> {};
...
class xlinear_hierarchy_generator<mpl::vector<T0, Args...>, U, Root>
 ...
 public:
  using base_type =
      U<T0, xlinear_hierarchy_generator<mpl::vector<Args...>, U, Root>>;
  template <class... T>
...
class xlinear_hierarchy_generator<mpl::vector<>, U, Root> : public Root {
 public:
  template <class... T>
  inline xlinear_hierarchy_generator(T&&... args)
