...
template <class T>
using is_gen_complex =
    disjunction<is_complex<std::decay_t<T>>, is_xcomplex<std::decay_t<T>>>;
...
template <class CTR1, class CTI1, bool ieee1, class CTR2, class CTI2,
          bool ieee2>
struct common_xcomplex {
  using type = xcomplex<std::common_type_t<CTR1, CTI1>,
                        std::common_type_t<CTR2, CTI2>, ieee1 || ieee2>;
};

template <class CTR1, class CTI1, bool ieee1, class CTR2, class CTI2,
          bool ieee2>
using common_xcomplex_t =
    typename common_xcomplex<CTR1, CTI1, ieee1, CTR2, CTI2, ieee2>::type;
...
class xcomplex {
 public:
  ...
  using real_const_reference =
      std::add_lvalue_reference_t<std::add_const_t<CTR>>;
  using real_rvalue_reference =
      std::conditional_t<std::is_reference<CTR>::value,
                         apply_cv_t<CTR, value_type>&, value_type>;
  using real_rvalue_const_reference =
      std::conditional_t<std::is_reference<CTR>::value, const value_type&,
                         value_type>;

  using imag_reference = std::add_lvalue_reference_t<CTI>;
  using imag_const_reference =
      std::add_lvalue_reference_t<std::add_const_t<CTI>>;
  using imag_rvalue_reference =
      std::conditional_t<std::is_reference<CTI>::value,
                         apply_cv_t<CTI, value_type>&, value_type>;
  using imag_rvalue_const_reference =
      std::conditional_t<std::is_reference<CTI>::value, const value_type&,
                         value_type>;

  constexpr xcomplex() noexcept : m_real(), m_imag() {}

  template <
      class OCTR,
      std::enable_if_t<conjunction<negation<is_gen_complex<OCTR>>,
                                   std::is_constructible<CTR, OCTR&&>,
                                   std::is_convertible<OCTR&&, CTR>>::value,
                       bool> = true>
  ...
  template <class OCTR,
            std::enable_if_t<
                conjunction<negation<is_gen_complex<OCTR>>,
                            std::is_constructible<CTR, OCTR&&>,
                            negation<std::is_convertible<OCTR&&, CTR>>>::value,
                bool> = true>
...
bool operator==(const xcomplex<CTR1, CTI1, B1>& lhs,
                const xcomplex<CTR2, CTI2, B2>& rhs) noexcept;
...
std::basic_ostream<OC, OT>& operator<<(std::basic_ostream<OC, OT>& out,
                                       const xcomplex<CTR, CTI, B>& c) noexcept;

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> operator+(
    const xcomplex<CTR, CTI, B>& rhs) noexcept;
...
template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
common_xcomplex_t<CTR1, CTI1, B1, CTR2, CTI2, B2> operator+(
    const xcomplex<CTR1, CTI1, B1>& lhs,
    const xcomplex<CTR2, CTI2, B2>& rhs) noexcept;

template <class CTR, class CTI, bool B, class T>
enable_scalar<T, temporary_xcomplex_t<CTR, CTI, B>> operator+(
    const xcomplex<CTR, CTI, B>& lhs, const T& rhs) noexcept;

template <class CTR, class CTI, bool B, class T>
enable_scalar<T, temporary_xcomplex_t<CTR, CTI, B>> operator+(
    const T& lhs, const xcomplex<CTR, CTI, B>& rhs) noexcept;
...
template <class CTR, class CTI, bool B>
typename xcomplex<CTR, CTI, B>::value_type abs(
    const xcomplex<CTR, CTI, B>& rhs);

template <class CTR, class CTI, bool B>
typename xcomplex<CTR, CTI, B>::value_type arg(
    const xcomplex<CTR, CTI, B>& rhs);

template <class CTR, class CTI, bool B>
typename xcomplex<CTR, CTI, B>::value_type norm(
    const xcomplex<CTR, CTI, B>& rhs);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> conj(const xcomplex<CTR, CTI, B>& rhs);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> proj(const xcomplex<CTR, CTI, B>& rhs);
...
template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> exp(const xcomplex<CTR, CTI, B>& rhs);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> log(const xcomplex<CTR, CTI, B>& rhs);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> log10(const xcomplex<CTR, CTI, B>& rhs);
...
template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
common_xcomplex_t<CTR1, CTI1, B1, CTR2, CTI2, B2> pow(
    const xcomplex<CTR1, CTI1, B1>& x, const xcomplex<CTR2, CTI2, B2>& y);

template <class CTR, class CTI, bool B, class T>
enable_scalar<T, temporary_xcomplex_t<CTR, CTI, B>> pow(
    const xcomplex<CTR, CTI, B>& x, const T& y);

template <class CTR, class CTI, bool B, class T>
enable_scalar<T, temporary_xcomplex_t<CTR, CTI, B>> pow(
    const T& x, const xcomplex<CTR, CTI, B>& y);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> sqrt(const xcomplex<CTR, CTI, B>& x);
...
template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> sin(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> cos(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> tan(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> asin(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> acos(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> atan(const xcomplex<CTR, CTI, B>& x);
...
template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> sinh(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> cosh(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> tanh(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> asinh(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> acosh(const xcomplex<CTR, CTI, B>& x);

template <class CTR, class CTI, bool B>
temporary_xcomplex_t<CTR, CTI, B> atanh(const xcomplex<CTR, CTI, B>& x);
...
template <class CTR, class CTI, bool B>
template <class OCTR>
inline auto xcomplex<CTR, CTI, B>::operator=(OCTR&& rhs) noexcept
    -> disable_xcomplex<OCTR, self_type&> {
...
template <class CTR, class CTI, bool B>
template <class OCTR, class OCTI, bool OB>
inline auto xcomplex<CTR, CTI, B>::operator=(
    const xcomplex<OCTR, OCTI, OB>& rhs) noexcept -> self_type& {
  m_real = rhs.m_real;
  m_imag = rhs.m_imag;
  return *this;
}
...
template <class OCTR, class OCTI, bool OB>
inline auto xcomplex<CTR, CTI, B>::operator=(
    xcomplex<OCTR, OCTI, OB>&& rhs) noexcept -> self_type& {
...
template <class CTR, class CTI, bool B>
inline xcomplex<CTR, CTI, B>::operator std::complex<std::decay_t<CTR>>()
    const noexcept {
...
struct xcomplex_multiplier {
  template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
  static auto mul(const xcomplex<CTR1, CTI1, B1>& lhs,
                  const xcomplex<CTR2, CTI2, B2>& rhs) {
  ...
  template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
  static auto div(const xcomplex<CTR1, CTI1, B1>& lhs,
                  const xcomplex<CTR2, CTI2, B2>& rhs) {
    using return_type = temporary_xcomplex_t<CTR1, CTI1, B1>;
    using value_type = typename return_type::value_type;
    value_type a = lhs.real();
...
struct xcomplex_multiplier<true> {
  ...
  static auto mul(const xcomplex<CTR1, CTI1, B1>& lhs,
    ...
    if (std::isnan(x) && std::isnan(y)) {
      ...
      if (!recalc && (std::isinf(ac) || std::isinf(bd) || std::isinf(ad) ||
                      std::isinf(bc))) {
        if (std::isnan(a)) {
          a = copysign(value_type(0), a);
        }
  ...
  static auto div(const xcomplex<CTR1, CTI1, B1>& lhs,
    ...
    if (std::isnan(x) && std::isnan(y)) {
      ...
      } else if (std::isinf(logbw) && logbw > value_type(0) &&
...
template <class CTR, class CTI, bool B>
template <class T>
inline auto xcomplex<CTR, CTI, B>::operator+=(const T& rhs) noexcept
    -> disable_xcomplex<T, self_type&> {
  m_real += rhs;
  return *this;
}
...
template <class CTR, class CTI, bool B>
constexpr auto xcomplex<CTR, CTI, B>::real() const& noexcept
    -> real_const_reference {
  return m_real;
}

template <class CTR, class CTI, bool B>
constexpr auto xcomplex<CTR, CTI, B>::real() const&& noexcept
    -> real_rvalue_const_reference {
  return m_real;
}
...
template <class CTR, class CTI, bool B>
constexpr auto xcomplex<CTR, CTI, B>::imag() const& noexcept
    -> imag_const_reference {
  return m_imag;
}

template <class CTR, class CTI, bool B>
constexpr auto xcomplex<CTR, CTI, B>::imag() const&& noexcept
    -> imag_rvalue_const_reference {
  return m_imag;
}

template <class CTR, class CTI, bool B>
inline auto xcomplex<CTR, CTI, B>::operator&() & noexcept
    -> xclosure_pointer<self_type&> {
  return xclosure_pointer<self_type&>(*this);
}

template <class CTR, class CTI, bool B>
inline auto xcomplex<CTR, CTI, B>::operator&() const& noexcept
    -> xclosure_pointer<const self_type&> {
...
template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
inline bool operator==(const xcomplex<CTR1, CTI1, B1>& lhs,
                       const xcomplex<CTR2, CTI2, B2>& rhs) noexcept {
...
template <class OC, class OT, class CTR, class CTI, bool B>
inline std::basic_ostream<OC, OT>& operator<<(
    std::basic_ostream<OC, OT>& out, const xcomplex<CTR, CTI, B>& c) noexcept {
  out << "(" << c.real() << "," << c.imag() << ")";
  return out;
}
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> operator+(
    const xcomplex<CTR, CTI, B>& rhs) noexcept {
  return rhs;
}
...
template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
inline common_xcomplex_t<CTR1, CTI1, B1, CTR2, CTI2, B2> operator+(
    const xcomplex<CTR1, CTI1, B1>& lhs,
    const xcomplex<CTR2, CTI2, B2>& rhs) noexcept {
...
template <class CTR, class CTI, bool B, class T>
inline enable_scalar<T, temporary_xcomplex_t<CTR, CTI, B>> operator+(
    const xcomplex<CTR, CTI, B>& lhs, const T& rhs) noexcept {
...
template <class CTR, class CTI, bool B>
inline typename xcomplex<CTR, CTI, B>::value_type abs(
    const xcomplex<CTR, CTI, B>& rhs) {
...
template <class CTR, class CTI, bool B>
inline typename xcomplex<CTR, CTI, B>::value_type arg(
    const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline typename xcomplex<CTR, CTI, B>::value_type norm(
    const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> conj(
    const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> proj(
    const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> exp(const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
  return std::exp(std::complex<value_type>(rhs));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> log(const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
  return std::log(std::complex<value_type>(rhs));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> log10(
    const xcomplex<CTR, CTI, B>& rhs) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR1, class CTI1, bool B1, class CTR2, class CTI2, bool B2>
inline common_xcomplex_t<CTR1, CTI1, B1, CTR2, CTI2, B2> pow(
    const xcomplex<CTR1, CTI1, B1>& x, const xcomplex<CTR2, CTI2, B2>& y) {
...
template <class CTR, class CTI, bool B, class T>
inline enable_scalar<T, temporary_xcomplex_t<CTR, CTI, B>> pow(
    const xcomplex<CTR, CTI, B>& x, const T& y) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> sqrt(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename xcomplex<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> sin(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::sin(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> cos(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::cos(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> tan(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::tan(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> asin(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::asin(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> acos(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::acos(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> atan(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
...
template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> sinh(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::sinh(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> cosh(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::cosh(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> tanh(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::tanh(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> asinh(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::asinh(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> acosh(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
  return std::acosh(std::complex<value_type>(x));
}

template <class CTR, class CTI, bool B>
inline temporary_xcomplex_t<CTR, CTI, B> atanh(const xcomplex<CTR, CTI, B>& x) {
  using value_type = typename temporary_xcomplex_t<CTR, CTI, B>::value_type;
...
auto forward_real(T&& v)
    -> std::enable_if_t<!is_gen_complex<T>::value,
...
auto forward_real(T&& v) -> std::enable_if_t<
    is_complex<T>::value,
    detail::forward_type_t<
        T, typename std::decay_t<T>::value_type>>  // complex case -> forward
                                                   // the real part
{
...
template <class T>
auto forward_real(T&& v)
    -> std::enable_if_t<is_xcomplex<T>::value,
                        decltype(std::forward<T>(v).real())> {
...
auto forward_imag(T&&)
    -> std::enable_if_t<!is_gen_complex<T>::value,
                        std::decay_t<T>>  // real case -> always return 0 by
                                          // value
{
  return 0;
}
...
auto forward_imag(T&& v) -> std::enable_if_t<
    is_complex<T>::value,
    detail::forward_type_t<
        T, typename std::decay_t<T>::value_type>>  // complex case -> forwards
                                                   // the imaginary part
{
...
template <class C, class T,
          std::enable_if_t<!xtl::is_complex<T>::value, int> = 0>
