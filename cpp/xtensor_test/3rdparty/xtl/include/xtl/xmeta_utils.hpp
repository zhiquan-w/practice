...
struct merge_set_impl<L<T...>, L<U1, U...>> {
  using type =
      typename merge_set_impl<if_t<contains<L<T...>, U1>, L<T...>, L<T..., U1>>,
                              L<U...>>::type;
};
}  // namespace detail
...
struct find_if_impl<Test, I, T0, T...>
    : std::conditional_t<Test<T0>::value, size_t_<I>,
...
template <class C, class T, class U>
struct switch_impl<C, T, default_t, U> : std::conditional<C::value, T, U> {};
}  // namespace detail
